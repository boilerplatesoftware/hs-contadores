...
export const SERVICES: ServiceItem[] = [
  {
    ...
    icon: <ShieldCheck className="w-8 h-8 text-[#004085]" />,
  ...
  },
  {
    ...
    icon: <FileText className="w-8 h-8 text-[#004085]" />,
  ...
  },
  {
    ...
    icon: <Users className="w-8 h-8 text-[#004085]" />,
  ...
  },
  {
    ...
    icon: <TrendingUp className="w-8 h-8 text-[#004085]" />,
  ...
  },
  {
    ...
    icon: <Gavel className="w-8 h-8 text-[#004085]" />,
  ...
  },
  {
    ...
    icon: <Briefcase className="w-8 h-8 text-[#004085]" />,
